...
@test "build workflows select upstream sources before building or publishing" {
    python3 - <<PYEOF
import yaml
...
for workflow_path in (
    ...
    assert "python3 snap/local/build/select_snapcraft_upstream.py" in combined, workflow_path
